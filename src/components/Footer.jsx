...
import { Terminal, Shield, Sparkles, Github, ExternalLink } from 'lucide-react';
...
export default function Footer({ easterEggUnlocked, onTriggerEasterEgg }) {
  ...
  return (
    <footer className="bg-slate-950 text-slate-400 border-t border-slate-800 transition-colors text-xs">
      
      {/* Decisions Markdown Embedded Preview Section */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-2 font-mono text-[11px]">
          ...
          <span className="text-slate-400">
            {easterEggUnlocked ? '⚡ Easter Egg Activated! (Acdyon Dev Mode)' : 'Hint: Try Konami Code or 4 clicks on logo'}
          </span>
        </div>

...
import { X, CheckSquare, Square, Calendar, CheckCircle2, RotateCcw, FileText } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end bg-slate-900/60 backdrop-blur-sm">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-lg bg-white dark:bg-[#131926] h-full shadow-2xl border-l border-slate-200 dark:border-slate-800 flex flex-col z-10 overflow-y-auto"
      >
        ...
        <div className="p-6 space-y-6 flex-1">
          ...
          <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
            <h3 className="text-xs font-mono font-bold uppercase text-blue-600 dark:text-blue-400 mb-1">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {role.notes.map((note, idx) => (
                <li key={idx} className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/30 border border-slate-200/60 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-300 leading-relaxed font-mono">
                  💡 {note}
                </li>
              ))}
            </ul>
